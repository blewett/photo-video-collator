...
#  displaying and managing them.
#
# This script will run the following steps to implement the system.
#
# turn on command echo - set -x
#
set -x
...
#
python3 files_add_md5.py files_list.txt > files_md5_list.txt
